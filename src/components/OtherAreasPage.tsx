          ...
          {areas.map((area, index) => (
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <Link href={`/other-areas/${area.slug}`} className="block mt-4">
                  <button className="w-full bg-primary cursor-pointer text-primary-foreground py-2 px-4 rounded-lg hover:bg-primary/90 transition-colors">
                    View Properties
                  </button>
                </Link>
              </CardContent>
