          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`space-y-10 scroll-slide-in-left ${formSection.isVisible ? 'animate' : ''}`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <a href="tel:9098668200" className="flex flex-1 items-center space-x-4 p-6 bg-white/20! hover:bg-white/30! duration-200 transition-colors backdrop-blur-sm rounded-xl border border-white/30">
                  <Phone className="h-8 w-8 text-white shrink-0" />
                  <div>
                    <p className="text-white/90 text-sm font-medium">Quick Call</p>
                    <p className="text-white font-bold text-lg">(909) 8668-200</p>
                  </div>
                </a>
